        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <h4 >SELAMAT DATANG DI APLIKASI SARPRAS</h4>
                    <h6 >Aplikasi Sarana & Prasarana Sekolah dibuat untuk mempermudah penggolongan dan inventarisasi Barang- Barang Milik Sekolah</h6>
                </div>
            </div>
        </div>
    </div>
