                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-judul_buku"  value="<?php  echo $this->set_field_value('judul_buku',""); ?>" type="text" placeholder="Enter Judul Buku"  required="" name="judul_buku"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
